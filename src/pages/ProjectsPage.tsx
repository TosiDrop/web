  ...
  return (
    <div className="space-y-7">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="label-eyebrow">Token management</p>
          <h1 className="mt-2 text-3xl font-semibold tracking-tight text-white">Your tokens</h1>
        ...
        >
          <IconRocket size={16} stroke={1.8} /> Register a token
        </Link>
      </header>
      <ProjectDashboard />
    </div>
