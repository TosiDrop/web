...
export function WelcomeStep() {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      {/* Brand mark */}
      <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#6F72F5] to-[#5A5DE8] p-[1.5px] shadow-lg shadow-brand-cyan/20">
        <div className="flex h-full w-full items-center justify-center rounded-[14px] bg-surface-raised">
          <span className="bg-gradient-to-br from-[#6F72F5] to-[#5A5DE8] bg-clip-text text-2xl font-bold text-transparent">
            T
          </span>
        </div>
      </div>
