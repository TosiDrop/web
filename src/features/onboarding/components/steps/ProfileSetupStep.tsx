    ...
    <div className="flex flex-col">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="group flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#6F72F5] to-[#5A5DE8] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-brand-cyan/10 transition-all hover:shadow-xl hover:shadow-brand-cyan/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan/40 disabled:opacity-40 disabled:hover:shadow-none"
        >
          Continue
