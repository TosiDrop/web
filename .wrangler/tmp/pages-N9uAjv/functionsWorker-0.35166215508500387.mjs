...
var init_resolveConfig = __esm({
  "../node_modules/axios/lib/helpers/resolveConfig.js"() {
    ...
    init_AxiosHeaders();
    init_buildURL();
    resolveConfig_default = /* @__PURE__ */ __name((config) => {
...
var apiToken, setApiToken, GET_FROM_VM;
var init_requests = __esm({
  "../node_modules/vm-sdk/dist/utils/requests.js"() {
    ...
    init_config();
    apiToken = "";
    setApiToken = /* @__PURE__ */ __name((token) => {
      apiToken = token;
    }, "setApiToken");
    GET_FROM_VM = class {
      static {
...
var AppError, handleError, getDefaultMessage;
var init_errorHandler = __esm({
  "../node_modules/vm-sdk/dist/utils/errorHandler.js"() {
    ...
    getDefaultMessage = /* @__PURE__ */ __name((status) => {
      switch (status) {
        case 400:
          return "Bad request";
        case 401:
...
__export(dist_exports, {
  GET_FROM_VM: () => GET_FROM_VM,
  getBlacklist: () => getBlacklist,
  getCustomRequest: () => getCustomRequest,
  getDeliveredRewards: () => getDeliveredRewards,
  getDistributions: () => getDistributions,
  getEstimateFees: () => getEstimateFees,
  getHealth: () => getHealth,
  getPendingTxCount: () => getPendingTxCount,
  getPools: () => getPools,
  getRewardBreakdown: () => getRewardBreakdown,
  getRewards: () => getRewards,
  getSanitizedAddress: () => getSanitizedAddress,
...
// api/profileData.ts
var onRequestPost, onRequestGet2;
...
// ../.wrangler/tmp/bundle-xQDN3Q/middleware-loader.entry.ts
init_functionsRoutes_0_5653304564625372();
init_strip_cf_connecting_ip_header();

// ../.wrangler/tmp/bundle-xQDN3Q/middleware-insertion-facade.js
init_functionsRoutes_0_5653304564625372();
init_strip_cf_connecting_ip_header();

// ../../../../../.nvm/versions/node/v22.13.1/lib/node_modules/wrangler/templates/pages-template-worker.ts
init_functionsRoutes_0_5653304564625372();
init_strip_cf_connecting_ip_header();

// ../../../../../.nvm/versions/node/v22.13.1/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
init_functionsRoutes_0_5653304564625372();
init_strip_cf_connecting_ip_header();
function lexer(str) {
  var tokens = [];
...
//# sourceMappingURL=functionsWorker-0.35166215508500387.mjs.map
